...
public class SpacePersonConverter {
    ...
    static {
        ...
        // write mappings for the rest of the alphabet
    }
    ...
    public static void main(String[] args) {
        ...
        // Create brand new Space Person alphabet
        HashMap<Character, Character> newSpacePersonAlphabet = createNewSpacePersonAlphabet();

        // Change to Space Person string using a whole new alphabet
        ...
        // Caesar cipher with a 5-character shift (english string)
        ...
        // Brute force all 0-25 shifts (english string)
    ...
    private static HashMap<Character, Character> createNewSpacePersonAlphabet() {
        ...
        // Use a variety set of symbols (~!@#$%^&*) for Space Person alphabet
